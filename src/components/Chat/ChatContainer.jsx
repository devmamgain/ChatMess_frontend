...
function ChatContainer({}) {
  ...
  // Scroll to the bottom of the container whenever messages are updated
  useEffect(() => {
  ...
  return (
    <div className="h-[80vh] w-full relative flex-grow overflow-auto custom-scrollbar" ref={chatContainerRef}>
